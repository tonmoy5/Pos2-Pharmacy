...
if(isset($_POST["submit"]))
{
    ...
    if($error == '')
    {
		$data = array(
			...
			':store_added_on'	    =>	date('Y-m-d H:i:s'),
            ':store_updated_on'     =>  date('Y-m-d H:i:s')
		);

		$query = "
		INSERT INTO store_msbs 
		(store_name, store_address, store_contact_no, store_email_address, store_timezone, store_currency, store_added_on, store_updated_on) 
		VALUES (:store_name, :store_address, :store_contact_no, :store_email_address, :store_timezone, :store_currency, :store_added_on, :store_updated_on)
		";
...
<html lang="en">
	<head>
        ...
        <title>Set Up Medical Store | Medical Store Management System in PHP</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Set Up Medical Store</h3></div>
                                    <div class="card-body">
                                        <?php
                                        if($error != '')
                                        {
                                        ...
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="store_name" type="text" name="store_name" placeholder="Enter Medical Store Name" value="<?php if(isset($_POST['store_name'])) echo $_POST['store_name']; ?>" />
                                                <label for="store_name">Medical Store Name</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="store_address" name="store_address" placeholder="Enter Medical Store Address"><?php if(isset($_POST['store_address'])) echo $_POST['store_address']; ?></textarea>
                                                <label for="store_address">Medical Store Address</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="store_contact_no" type="text" name="store_contact_no" placeholder="Enter Contact No." value="<?php if(isset($_POST['store_contact_no'])) echo $_POST['store_contact_no']; ?>" />
                                                <label for="store_contact_no">Medical Store Contact No.</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="store_email_address" type="text" name="store_email_address" placeholder="Enter Email Address" value="<?php if(isset($_POST['store_email_address'])) echo $_POST['store_email_address']; ?>" />
